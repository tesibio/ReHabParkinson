...
class terapia_ec05() : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_terapia_ec05)
        ...
        // Lista de pasos
        val pasos = listOf(
            "Párese con los pies separados a la anchura de los hombros y los brazos a los costados.",
            "Levante el brazo derecho lo más alto que pueda, sin doblar el codo, mientras separa lateralmente el brazo izquierdo a la altura del hombro.",
            "Regrese al centro.",
            "Ahora invierta el movimiento: levante el brazo izquierdo lo más alto que pueda, sin doblar el codo, y separe el brazo derecho a la altura del hombro.",
        ...
        btnEjemplo.setOnClickListener {
            ...
            val videoUri = Uri.parse("android.resource://$packageName/${R.raw.video_ec05}")
